...
class BasePage(object):
    ...
    def open(self, url):
        ...
        Usage:
        driver.open("https://www.lemfix.com")
        """
        t1 = time.time()
        try:
            self.driver.get(url)
            ...
            logger.error("{0} Unable to load {1}, Spend {2} seconds".format(fail, url, time.time() - t1))
            raise
    ...
    def set_window(self, wide, high):
        ...
        logger.info("{0} Set browser window wide: {1},high: {2}, Spend {3} seconds".format(success,
    ...
    def click_text(self, text):
        ...
        try:
            ...
            logger.error("{0} Unable to Click by text content: {1}, Spend {2} seconds".format(fail, text, time.time() - t1))
            raise
    ...
    def submit(self, css):
        ...
        try:
            ...
            logger.error("{0} Unable to submit form args element: <{1}>, Spend {2} seconds".format(fail, css, time.time() - t1))
            raise
    ...
    def js(self, script):
        ...
        try:
            ...
            logger.error("{0} Unable to execute javascript scripts: {1}, Spend {2} seconds".format(fail,
                script, time.time() - t1))
            raise
    ...
    def get_attribute(self, css, attribute):
        ...
        try:
            ...
            logger.info("{0} Get attribute element: <{1}>,attribute: {2}, Spend {3} seconds".format(success,
                css,attribute,time.time()-t1))
            return attr
        except Exception:
            logger.error("{0} Unable to get attribute element: <{1}>,attribute: {2}, Spend {3} seconds".format(fail,
                css, attribute,time.time() - t1))
            raise
    ...
    def get_text(self, css):
        ...
        try:
            ...
            logger.info("{0} Get element text element: <{1}>, Spend {2} seconds".format(success,css,time.time()-t1))
            return text
        except Exception:
            logger.error("{0} Unable to get element text element: <{1}>, Spend {2} seconds".format(fail, css, time.time() - t1))
            raise
    ...
    def wait(self, secs):
        ...
        logger.info("{0} Set wait all element display in {1} seconds, Spend {2} seconds".format(success,
            secs,time.time() - t1))
    ...
    def switch_to_frame(self, css):
        ...
        try:
            ...
            logger.error("{0} Unable switch to frame element: <{1}>, Spend {2} seconds".format(fail, css, time.time() - t1))
            raise
    ...
    def open_new_window(self, css):
        ...
        try:
            ...
            logger.info("{0} Click element: <{1}> open a new window and swich into, Spend {2} seconds".format(success,
                css,time.time() - t1))
        except Exception:
            logger.error("{0} Click element: <{1}> open a new window and swich into, Spend {2} seconds".format(fail,
                css,time.time() - t1))
            raise
    ...
    def element_exist(self, css):
        ...
        try:
            self.element_wait(css)
            logger.info("{0} Element: <{1}> is exist, Spend {2} seconds".format(success,css, time.time() - t1))
            return True
        except TimeoutException:
            logger.info("{0} Element: <{1}> is not exist, Spend {2} seconds".format(fail, css, time.time() - t1))
            return False
    ...
    def take_screenshot(self, file_path):
        ...
        try:
            ...
            logger.info("{0} Get the current window screenshot,path: {1}, Spend {2} seconds".format(success,
                file_path, time.time() - t1))
        except Exception:
            logger.error("{0} Unable to get the current window screenshot,path: {1}, Spend {2} seconds".format(fail,
                file_path,time.time() - t1))
            raise
    ...
    def type_and_enter(self, css, text, secs=0.5):
        ...
        try:
            ...
            logger.info("{0} Element <{1}> type content: {2},and sleep {3} seconds,input ENTER key, Spend {4} seconds".format(
                success,css,text,secs,time.time() - t1))
        except Exception:
            logger.error("{0} Unable element <{1}> type content: {2},and sleep {3} seconds,input ENTER key, Spend {4} seconds".
    ...
    def js_click(self, css):
        ...
        try:
            ...
            logger.error("{0} Unable to use javascript click element: {1}, Spend {2} seconds".format(fail,
                js_str, time.time() - t1))
            raise
